jQuery(document).ready(function($) {
  ...
  let back = $("#go-back");
    ...
    $("#meet").css("text-align", "center");
		const domain = "meet.jit.si";
		const options = {
			roomName: "HorusHealth1",
  ...
  var OnePageNavigation = function() {
    ...
    $("body").on(
      "click",
      ".main-menu li a[href^='#'], .smoothscroll[href^='#'], .site-mobile-menu .site-nav-wrap li a, .btn-scroll",
      function(e) {
        e.preventDefault();
